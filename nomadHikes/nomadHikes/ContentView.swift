...
struct ContentView: View {
    ...
    var onboardingDataArray: [OnboardingModel] = [
        OnboardingModel(id: 2, image: "photography", titleText: "Travel the World", descriptionText: "Explore the world and get to know different cultures and people from all around the world"),
        OnboardingModel(id: 1, image: "hikingmental", titleText: "Activities", descriptionText: "Get to know about the most famous spots for adventures and activities."),
